    ...
    *,
    ...
    for i, param in enumerate(params):
        ...
        if capturable or differentiable:
            ...
            # No bias correction for first moment
            param.addcdiv_(grad, denom, value=-lr * (overshoot/beta1) * (1 - beta1))
            param.addcdiv_(exp_avg, denom, value=-lr * (overshoot - overshoot/beta1 + 1))
